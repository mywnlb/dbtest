...
/**
 * 表示SQL 词法与语法解析中的 {@code BitLiteralNode} 不可变 AST 节点；保留源位置与语法值，binder 只读取该节点，不允许解析后就地改写。
 *
 ...
 */
public record BitLiteralNode(String value, String lexeme, SourcePosition position) implements LiteralNode { }
